...
const Services = () => {
  ...
  return (
    <>
      <PageHead 
        title="Services"
        description="Comprehensive business solutions from telecommunications and digital transformation to management—discover how Zaytrix delivers integrated success."
        keywords="services, telecommunications, digital technology, management, Zaytrix"
        canonicalUrl="https://zaytrix.com/services"
      />
      <div className="min-h-screen">
        ...
        <HeroSection
          ...
          subtitle=""
          description="From telecommunications infrastructure to digital transformation and financial management, we provide integrated solutions that drive business success."
          primaryCTA={{
